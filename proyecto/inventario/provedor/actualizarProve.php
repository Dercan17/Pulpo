...
$id = $_GET['id'];
$consul = $prov->consultarProvedor($id);
...
<table class="table table-hover table-dark">
  ...
  <label class="form-label">Nit provedor</label><br>
  <input class="form-control" type="text" value="<?php echo $row["NiT_provedor"];  ?>" name="Nit_prove">
  <br><br>
  ...
  <label class="form-label">Dirrecion</label><br>
   <input class="form-control" type="text" value="<?php echo $row["Dirrecion"];  ?>" name="direc">
<br><br>
   <input class="btn btn-primary" type="submit" value="Actualizar" name="actualizar">
   <a class="btn btn-secondary" href="ingresarProve.php"> Ver Provedores</a>
